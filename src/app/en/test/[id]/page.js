...
export default function EnglishTestPage({ params }) {
  ...
  return (
    <div className="flex flex-col items-center justify-center p-16">
      ...
      <Link href="/en/test" className="px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-600 transition-colors">
        {t("BackToTestPage")}
      </Link>
    </div>
  );
